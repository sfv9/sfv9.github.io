...
function StatStrip() {
  return (
    <section style={{ padding: '0 60px', margin: '0 0 0' }}>
      <div style={{
        background: 'var(--gradient-ink)', borderRadius: 'var(--radius-xl)',
        padding: '56px 48px', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)',
        gap: 32, boxShadow: 'var(--shadow-xl)', transform: 'translateY(-40px)',
      }}>
        {STATS.map((s) => (
